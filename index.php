                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a onclick="selection('tea');" href="#">&#1063;&#1072;&#1081;&#1086;&#1082;</a>
                            </li>
                            <li><a onclick="selection('cass');" href="#">&#1055;&#1088;&#1080;&#1085;&#1090;&#1077;&#1088;</a>
                            </li>
...
if (isset($HTTP_GET_VARS[success])) {
  ...
  echo "<h3>Додати запис";
            ...
            <form name="addForm" action="add.php" method="post">
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="cell" onclick="printDate(document.getElementById('dateTime'));">Дата та час</div>
                        </td>
                        <td>
        ...
        <script type="text/javascript">
          printDate(document.getElementById('dateTime'));
        </script>
